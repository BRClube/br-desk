...
const Layout: React.FC<LayoutProps> = ({ children, activeDept, activeSubmodule, onNavigate }) => {
  ...
  // Cor de fundo padrão (usando a mesma da sidebar desktop para consistência)
  const BG_COLOR = "bg-[#00003D]";

  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#f5fdff]">
      
      {/* --- SIDEBAR DESKTOP (MANTIDA IGUAL, APENAS OTIMIZADA) --- */}
        ...
        <div className="p-8 mb-4">
          <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'space-x-3'}`}>
            <div className="rounded-xl w-10 h-10 flex items-center justify-center shadow-lg bg-white overflow-hidden">
               {/* Ajuste na imagem para garantir que ela preencha o container */}
      ...
      {/* Adicionado BG_COLOR fixo e z-index alto */}
      ...
      {/* 1. bg-navy-deep trocado por BG_COLOR explícito */}
      {/* 2. padding-top (pt-20) ajustado para não ficar embaixo do header */}
      {isMobileMenuOpen && (
